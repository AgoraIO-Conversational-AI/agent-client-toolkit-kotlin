package io.agora.agent.toolkit.sample.ui.common
...
abstract class BaseFragment<VB : ViewBinding> : Fragment() {
     ...
     */
    open fun immersiveMode(): BaseActivity.ImmersiveMode = BaseActivity.ImmersiveMode.SEMI_IMMERSIVE
    ...
    protected fun setupSystemBarsAndCutout(
        immersiveMode: BaseActivity.ImmersiveMode = BaseActivity.ImmersiveMode.EDGE_TO_EDGE,
